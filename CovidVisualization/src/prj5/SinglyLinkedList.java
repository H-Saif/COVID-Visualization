...
public class SinglyLinkedList<E> implements LList<E> {
    ...
    public void insertionSort(Comparator<E> c) {
        if (size > 0) {
            ...
            while (unsorted != null) {
                Node<E> toInsert = unsorted;
                unsorted = unsorted.next();
                insertInOrder(toInsert, c);
            }
        }
    }
     ...
     *            comparator
     */
    private void insertInOrder(Node<E> toInsert, Comparator<E> c) {
        E item = toInsert.getData();
        Node<E> curr = head;
        Node<E> prev = null;
